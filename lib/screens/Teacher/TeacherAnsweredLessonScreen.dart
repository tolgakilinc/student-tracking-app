...
class TeacherAnsweredLessonScreen extends StatelessWidget {
  User user;
  TeacherAnsweredLessonScreen({Key key, this.user}) : super(key: key);
              ...
              return ListTile(
                ...
                onTap: (){
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) {
                        return TeacherAnsweredQuestionList(user: user, lesson: item,);
                      },
                    ),
                  );
                },
