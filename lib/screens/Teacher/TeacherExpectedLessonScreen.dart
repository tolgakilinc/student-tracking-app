...
import 'package:developer_student/screens/Teacher/TeacherAnsweredQuestionList.dart';
import 'package:developer_student/screens/Teacher/TeacherExpectedQuestionList.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';

import '../../constans.dart';

class TeacherExpectedLessonScreen extends StatelessWidget {
  User user;
  TeacherExpectedLessonScreen({Key key, this.user}) : super(key: key);
              ...
              return ListTile(
                ...
                onTap: (){
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) {
                        return TeacherExpexctedQuestionList(user: user, lesson: item);
                      },
                    ),
                  );
                },
